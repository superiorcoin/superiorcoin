...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 SUPR
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 SUPR mininput
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
    	return dPriority > COIN * 2880 / 250; // SuperiorCoin: 2880 blocks found a day. Priority cutoff is 1 superiorcoin day / 250 bytes.
    }
